...
\begin{document}
    ...
    We first assume that this solution saturates $\boldsymbol b$, i.e.\ the optimal primal solution $D$ satisfies
    \[
    ...
    So $D$ induces a $i$--$v$ flow for each $i \in W$ of at least $b_i$, following directly from the fact that $\boldsymbol b$ is saturated.
